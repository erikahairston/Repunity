...
class discoverVC: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    let industries :  [String] = ["Architecture", "Communications", "Consulting", "Education", "Energy", "Entertainment", "Environment", "Finance", "Fine-Arts", "Government", "Healthcare", "Law" ,"Publishing/Media", "Religious-Institution", "Retail", "Social Work", "Technology", "Executive"]
