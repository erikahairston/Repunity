...
class industrySignUpViewController: UIViewController, UITableViewDelegate, UITableViewDataSource  {
    ...
    override func viewDidLoad() {
        ...
        industryNames = ["Architecture", "Communications", "Consulting", "Education", "Energy", "Entertainment", "Environment", "Finance", "Fine-Arts", "Government", "Healthcare", "Law" ,"Publishing/Media", "Religious-Institution", "Retail", "Social Work", "Technology", "Executive"]
